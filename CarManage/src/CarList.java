...
//            aPartOfBrandName = o.getBrandName();
//            System.out.print(aPartOfBrandName);
//            for (int i = 0; i < listCar.size() - 1; i++) {
//                System.out.print(aPartOfBrandName);
//                Car c = this.get(i);
//                if (c.getBrand().getBrandName().contains(aPartOfBrandName)) {
//                    System.out.print(c.getBrand().getBrandName().substring(indexOf(aPartOfBrandName)));
//                    count++;
//                    
//                }
//            }
